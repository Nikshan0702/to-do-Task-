...
//       const response = await fetch(`http://localhost:5001/api/task/${numericId}`, {
//         method: 'PUT',
//         headers: {
//           'Content-Type': 'application/json',
//         },
//         body: JSON.stringify({
//           status: 'completed' // Explicit string value
//         })
//       });
...
//                     style={{ width: `${Math.min(100, (incompleteTasks.length / 5) * 100)}%` }}
//                   ></div>
//                 </div>
//               </div>
